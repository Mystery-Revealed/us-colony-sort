...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'us-colony-sort', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[us-colony-sort] listening on :${config.port} — sessions live in memory only`);
});
